...
var genericAWSClient = function(obj) {
  ...
  obj.call = function (action, query, callback) {
    ...
    var options = {
      agent: false, //fd: forcing http://engineering.linkedin.com/nodejs/blazing-fast-nodejs-10-performance-tips-linkedin-mobile
      host: obj.host,
      path: obj.path,
      method: 'POST',
      headers: headers
  ...
  obj.sign = function (query) {
	...
	//fd: console.log( "to sign: " + stringToSign);
